 ...
 */
public class RequestBaseAdapter extends BaseAdapter {
    private static ArrayList<Request> requestsArrayList;
    private String dueTime;

    private LayoutInflater mInflater;

    public RequestBaseAdapter(Context context, ArrayList<Request> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.layout_my_request_list, null);
        ...
        holder.lblFrom.setText(requestsArrayList.get(position).getSrcAddress());
        holder.lblTo.setText(requestsArrayList.get(position).getDestAddress());
